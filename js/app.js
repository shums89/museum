(() => {
    ...
    function formQuantity() {
        document.addEventListener("click", (function(e) {
            ...
            if (targetElement.closest(".quantity__button")) {
                ...
                input.value = value;
                if (typeof minValue !== NaN) btnMinus.disabled = value === minValue;
                if (typeof maxValue !== NaN) btnPlus.disabled = value === maxValue;
            }
        }));
    }
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".welcome-slider__slider")) new swiper_core_Swiper(".welcome-slider__slider", {
        ...
        if (document.querySelector(".video-slider-view")) new swiper_core_Swiper(".video-slider-view", {
        ...
        if (document.querySelector(".video-slider-preview")) new swiper_core_Swiper(".video-slider-preview", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    videoSlider.querySelector(".slide-controls__fullscreen-toggle");
    let videoPlayer;
    ...
    videoSlider.addEventListener("click", (e => {
        ...
        e.preventDefault();
        getPlayerActive();
        if (target.closest(".video-slider-view__slide") || target.closest(".slide-controls__play-toggle")) if (videoPlayer.paused) {
            videoPlayer.play();
        ...
        if (target.closest(".slide-controls__fullscreen-toggle")) videoPlayer.requestFullscreen();
    ...
    pictureInnerContainer.children[0];
    const shuffle = array => {
    ...
    shuffle(Array(15).fill().map(((el, i) => i + 1))).map((el => {
